...
/* 1. Add a new age to your array and repeat the step above to ensure it is
...
/* 6. Write a loop to iterate over the nameLengths array and calculate the sum of all the elements in the array.
 ...
 /* 7. Write a function that takes two parameters, word and n, as arguments and returns the word concatenated to
  ...
  /* I googled how to log out the same string multiple times and a description of "repeat" came up and I decided to try it.*/
 ...
 */
  ...
  /* I would like to compare: a) miles I ran for the current week to miles I ran for the previous week and 
     ...
     If not, then I will repeat the training for the current week, instead.
  */
